  ...
  "node_modules/konva/lib/Node.js"(exports) {
    ...
    var Node = class _Node {
      ...
      _getTransform() {
        ...
        m.reset();
        const x = this.x(), y2 = this.y(), rotation = Global_1.Konva.getAngle(this.rotation()), scaleX = (_a2 = this.attrs.scaleX) !== null && _a2 !== void 0 ? _a2 : 1, scaleY = (_b = this.attrs.scaleY) !== null && _b !== void 0 ? _b : 1, skewX = this.attrs.skewX || 0, skewY = this.attrs.skewY || 0, offsetX = this.attrs.offsetX || 0, offsetY = this.attrs.offsetY || 0;
        if (x !== 0 || y2 !== 0) {
          m.translate(x, y2);
        }
        if (rotation !== 0) {
  ...
  "node_modules/konva/lib/Tween.js"(exports) {
    ...
    exports.Easings = {
      ...
      ElasticEaseIn(t, b2, c, d, a, p2) {
        ...
        return -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p2)) + b2;
      },
      ElasticEaseOut(t, b2, c, d, a, p2) {
        let s = 0;
        if (t === 0) {
          return b2;
        }
        ...
        return a * Math.pow(2, -10 * t) * Math.sin((t * d - s) * (2 * Math.PI) / p2) + c + b2;
      },
      ElasticEaseInOut(t, b2, c, d, a, p2) {
        let s = 0;
        if (t === 0) {
          return b2;
        }
        ...
        if (t < 1) {
          return -0.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p2)) + b2;
        }
        return a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p2) * 0.5 + c + b2;
      },
  ...
  "node_modules/konva/lib/BezierFunctions.js"(exports) {
    ...
    var getCubicArcLength = (xs, ys, t) => {
      ...
      for (let i2 = 0; i2 < n; i2++) {
        correctedT = z2 * exports.tValues[n][i2] + z2;
    ...
    function filterGaussBlurRGBA(imageData, radius) {
      ...
      for (let x = 0; x < width; x++) {
        ...
        for (let y2 = 0; y2 < height; y2++) {
          ...
          b_out_sum -= stackIn.b;
          a_out_sum -= stackIn.a;
          p2 = x + ((p2 = y2 + radiusPlus1) < heightMinus1 ? p2 : heightMinus1) * width << 2;
  ...
  "node_modules/konva/lib/filters/Emboss.js"(exports) {
    ...
    var Emboss = function(imageData) {
      ...
      do {
        ...
        const offsetYOther = (y2 - 1 + otherY) * w * 4;
        let x = w;
        do {
  ...
  "node_modules/konva/lib/filters/HSL.js"(exports) {
    ...
    var HSL = function(imageData) {
      ...
      for (let i2 = 0; i2 < nPixels; i2 += 4) {
        ...
        b2 = data[i2 + 2];
        a = data[i2 + 3];
        data[i2 + 0] = rr * r + rg * g + rb * b2 + l;
        data[i2 + 1] = gr * r + gg * g + gb * b2 + l;
        data[i2 + 2] = br * r + bg * g + bb * b2 + l;
        data[i2 + 3] = a;
      }
    };
    exports.HSL = HSL;
...
var require_Kaleidoscope = __commonJS({
  "node_modules/konva/lib/filters/Kaleidoscope.js"(exports) {
    ...
    var Kaleidoscope = function(imageData) {
      ...
      let x, y2, xoff, i2, r, g, b2, a, srcPos, dstPos;
...
function M(o, n, c, a) {
  ...
  for (let t in c) {
    ...
    if (s && f) {
      ...
      g.slice(0, 7) === "content" && (g = "content" + g.slice(7, 1).toUpperCase() + g.slice(8)), e == null ? void 0 : e.off(g + S, c[t]);
    }
    !n.hasOwnProperty(t) && (e == null ? void 0 : e.setAttr(t, void 0));
  }
  for (let t in n) {
    if (T.hasOwnProperty(t))
      continue;
    ...
    if (s && f) {
      ...
      d.slice(0, 7) === "content" && (d = "content" + d.slice(7, 1).toUpperCase() + d.slice(8)), n[t] && (e == null ? void 0 : e.off(d + S), e == null ? void 0 : e.on(d + S, n[t]));
    }
    !s && (n[t] !== c[t] || a && n[t] !== (e == null ? void 0 : e.getAttr(t))) && (r = true, l[t] = n[t]);
  }
...
function G(o) {
  function n(c) {
    return (c == null ? void 0 : c.__konvaNode) ? c : (c == null ? void 0 : c.parent) ? n(c.parent) : (console.error("vue-konva error: Can not find parent node"), null);
  }
  return n(o.parent);
}
function R(o) {
...
function W(o) {
  ...
  if ((n == null ? void 0 : n.tagName) && c && !a) {
...
var _a;
var D = ((_a = import_konva.default.default) == null ? void 0 : _a.Stage) || import_konva.default.Stage;
var Y = defineComponent({
  ...
  setup(o, { attrs: n, slots: c, expose: a }) {
    ...
    if (!e) return;
    const l = reactive({}), r = ref(null), t = new D({
    ...
    return onMounted(() => {
      ...
      return h(
        "div",
        {
          ...
          accesskey: n == null ? void 0 : n.accesskey,
        ...
        (_a2 = c.default) == null ? void 0 : _a2.call(c)
      );
    };
  }
});
...
function i(o, n) {
  return defineComponent({
    ...
    setup(c, { attrs: a, slots: e, expose: l }) {
      ...
      if (!r) return;
      const t = reactive({}), s = new n();
      r.__konvaNode = s, r.vnode.__konvaNode = s, g();
      function f() {
        return r == null ? void 0 : r.__konvaNode;
      }
      function d() {
        return r == null ? void 0 : r.__konvaNode;
      }
      function g() {
        if (!r) return;
        const v = {};
        for (const h2 in r == null ? void 0 : r.vnode.props)
          h2.slice(0, 2) === "on" && (v[h2] = r.vnode.props[h2]);
        const K = t || {}, E = {
          ...a,
          ...c.config,
          ...v
      ...
      return () => {
        var _a2;
        return m ? (_a2 = e.default) == null ? void 0 : _a2.call(e) : null;
      };
    }
  });
}
function Ne(o, n, c) {
  const a = ref(null), e = ref("loading"), l = (t, s, f) => {
    e.value = "loading";
    const d = new Image();
    ...
    url: toValue(o),
    crossorigin: toValue(n),
    referrerPolicy: toValue(c)
  }));
  return watch(
    r,
...
var Se = {
  install: (o, n) => {
    const c = (n == null ? void 0 : n.prefix) || F, a = (n == null ? void 0 : n.customNodes) ? Object.entries(n.customNodes).map(
      ([l, r]) => i(l, r)
    ) : [];
    [
      Y,
