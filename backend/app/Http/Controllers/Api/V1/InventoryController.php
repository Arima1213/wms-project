...
class InventoryController extends Controller
{
    ...
    {
        $query = Inventory::with(['product:id,sku,name,barcode,category_id', 'warehouse:id,code,name', 'rackSlot:id,slot_code'])
    ...
    public function trace(Request $request, string $sku): JsonResponse
    {
        ...
        $locations = Inventory::with(['warehouse:id,code,name', 'rackSlot:id,slot_code', 'rackSlot.level.rack:id,code,name'])
